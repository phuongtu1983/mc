 ...
 * @version $Revision: 1.1 $ ($Author: thuhc $)
 */
public class Anchor
{
    ...
    private String getHrefString()
    {
        ...
        String strHref = this.href.toString();
        if (strHref.startsWith("javascript:")) {
            return " href=\"#\" onclick=\"" + strHref + "\""; //$NON-NLS-1$ //$NON-NLS-2$                        
        } else {
            return " href=\"" + strHref + "\""; //$NON-NLS-1$ //$NON-NLS-2$            
        }
