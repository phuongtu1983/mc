 ...
 * @version $Id: TotalTableDecorator.java,v 1.7 2012/05/26 09:00:25 locmai Exp $
 */
public class TotalTableDecorator extends TableDecorator
{
     ...
     * Logger.
     */
    protected static Log log = LogFactory.getLog(TotalTableDecorator.class);

    /**
     * total amount.
     */
    protected Map grandTotals = new HashMap();

    /**
     * total amount for current group.
     */
    protected Map subTotals = new HashMap();
     ...
     */
    protected String groupPropertyName;

    /**
     * Label used for subtotals. Default: "{0} total".
     */
    protected String subtotalLabel = "{0} subtotal";
