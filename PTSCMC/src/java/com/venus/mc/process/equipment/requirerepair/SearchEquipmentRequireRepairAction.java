 ...
 * @author mai vinh loc
 */
public class SearchEquipmentRequireRepairAction extends SpineAction {
    ...
    public boolean doAction(ActionMapping mapping, ActionForm form,
        ...
        try {
           EquipmentDAO equipmentDAO = new EquipmentDAO();
            equipmentList = equipmentDAO.searchSimpleEquipmentofRequireRepair(fieldid, StringUtil.encodeHTML(strFieldvalue), ReportDamageBean.COMPLETED0,MCUtil.getOrganizationID(session));
        } catch (Exception ex) {
