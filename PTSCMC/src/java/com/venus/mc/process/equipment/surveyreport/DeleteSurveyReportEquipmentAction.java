 ...
 * @author mai vinh loc
 */
public class DeleteSurveyReportEquipmentAction extends SpineAction {
        ...
        try {
            ...
            for (int i = 0; i < length; i++) {
                if (!arrDetId[i].equals("0")) {
                    requestDAO.deleteSurveyReportDetail(arrDetId[i]);
                }
            }
            ...
            LogUtil.error("FAILED:SurveyReportDetail:delete-" + ex.getMessage());
            ex.printStackTrace();
        }
        return true;
    }
