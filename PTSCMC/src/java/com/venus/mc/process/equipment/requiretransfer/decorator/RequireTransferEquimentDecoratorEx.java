 ...
 * @author thcao
 */
public class RequireTransferEquimentDecoratorEx extends TotalTableDecorator {

    public RequireTransferEquimentDecoratorEx() {
        super();
    }
...
//        }        
        ...
        return "<input type=\"checkbox\" name=\"chkDetId\" value=\"rt_" +  idx + "\"" + disabled +
                //" onclick=\"removeMrvRow(" + bean.getDetId()+ ")\"" +
                "><input type=\"hidden\" name=\"detId\" value=\"rt_" + idx + "\"" + ">";
    }
    ...
    public String getStatusApprove() {
        ...
        str += "<option value=\"1\" selected=\"selected\" >" + MCUtil.getBundleString("message.requiretransfer.statusapprove1") + "</option>";
        str += "<option value=\"2\" >" + MCUtil.getBundleString("message.requiretransfer.statusapprove2") + "</option>";
        str += "<option value=\"3\" >" + MCUtil.getBundleString("message.requiretransfer.statusapprove3") + "</option>";
        str += "</select>";
        return str;
    }
    ...
    public String getTimeEstimate() {
        ...
        EquipmentBean bean = (EquipmentBean) getCurrentRowObject();
        return "<input type=\"text\" size=\"10\" onclick=\"javascript: showCalendar('timeEstimate"+rand+"')\" id=\"timeEstimate"+rand+"\" name=\"timeEstimate\" value=\"\"" + ">";
    }
    ...
    public String addRowId() {        
        return "reqver_detail_row_" + (getListIndex()+1);
    }
}
