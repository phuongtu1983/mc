 ...
 * @author kngo
 */
public class SearchSimpleEmcoAction extends SpineAction {
    ...
    public boolean doAction(ActionMapping mapping, ActionForm form,
        ...
        try {
            emcoList = emcoDAO.searchSimpleEmco(fieldid, StringUtil.encodeHTML(strFieldvalue));
        } catch (Exception ex) {
            LogUtil.error("FAILED: EmcoBean:searchSimpleEmco-" + ex.getMessage());
            ex.printStackTrace();
        }
