 ...
 * @author kngo
 */
public class DeleteMcDetailAction extends SpineAction {
    ...
    public boolean doAction(ActionMapping mapping, ActionForm form,
        ...
        String[] arrDetId = request.getParameterValues("mcEquipmentChk");
        try {
            ...
            for (int i = 0; i < length; i++) {
                if (!arrDetId[i].equals("0")) {
                    mcDAO.deleteMcDetail(NumberUtil.parseInt(arrDetId[i], 0));
                }
            }
