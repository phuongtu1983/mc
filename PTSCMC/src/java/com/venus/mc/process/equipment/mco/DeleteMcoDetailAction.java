 ...
 * @author kngo
 */
public class DeleteMcoDetailAction extends SpineAction {
    ...
    public boolean doAction(ActionMapping mapping, ActionForm form,
        ...
        String[] arrDetId = request.getParameterValues("mcoEquipmentChk");
        try {
            ...
            for (int i = 0; i < length; i++) {
                if (!arrDetId[i].equals("0")) {
                    mcoDAO.deleteMcoDetail(NumberUtil.parseInt(arrDetId[i], 0));
                }
            }
