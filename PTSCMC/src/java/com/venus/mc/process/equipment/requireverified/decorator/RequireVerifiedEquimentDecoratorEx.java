 ...
 * @author thcao
 */
public class RequireVerifiedEquimentDecoratorEx extends TotalTableDecorator {    

    public RequireVerifiedEquimentDecoratorEx() {
        super();        
    }
...
//        }        
        ...
        return "<input type=\"checkbox\" name=\"chkDetId\" value=\"rvd_" +  idx + "\"" + disabled +
                //" onclick=\"removeMrvRow(" + bean.getDetId()+ ")\"" +
                "><input type=\"hidden\" name=\"detId\" value=\"rvd_" + idx + "\"" + ">";
    }
    ...
    public String getTimeEstimate() {
        return "<input type=\"text\" size=\"6\" name=\"timeEstimate\" value=\"\"" + ">";
    }
