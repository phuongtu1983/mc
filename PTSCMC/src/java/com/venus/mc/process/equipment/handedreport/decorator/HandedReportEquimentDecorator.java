 ...
 * @author thcao
 */
public class HandedReportEquimentDecorator extends TotalTableDecorator {

    public HandedReportEquimentDecorator() {
        super();
    }

    public String getDelId() {
        HandedReportDetailBean bean = (HandedReportDetailBean) getCurrentRowObject();
        String disabled = "";
//        if (bean.getStatus() == 1) {
//            disabled = "disabled";
//        }        
    ...
    public String getQuantity() {
        HandedReportDetailBean bean = (HandedReportDetailBean) getCurrentRowObject();
        return "<input type=\"text\" size=\"10\" name=\"quantity\" value=\"" + bean.getQuantity() + "\"" + ">";
    }
    ...
    public String getSpecifications() {
        HandedReportDetailBean bean = (HandedReportDetailBean) getCurrentRowObject();
        return "<input type=\"text\" size=\"20\" name=\"specifications\" value=\"" + bean.getSpecifications() + "\"" + ">";                
    }
    ...
    public String addRowId() {
        HandedReportDetailBean bean = (HandedReportDetailBean) getCurrentRowObject();
        return "hr_detail_row_" + bean.getDetId();
    }
}
