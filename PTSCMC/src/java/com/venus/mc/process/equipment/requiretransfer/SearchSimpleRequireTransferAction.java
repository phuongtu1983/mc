 ...
 * @version
 */
public class SearchSimpleRequireTransferAction extends SpineAction {
    ...
    public boolean doAction(ActionMapping mapping, ActionForm form,
        ...
        try {
            requestList = requestDAO.searchSimpleRequireTransfer(fieldid, StringUtil.encodeHTML(strFieldvalue));
        } catch (Exception ex) {
            LogUtil.error(getClass().getName() + ": " + ex.getMessage());            
        }
        request.setAttribute(Constants.REQUIRETRANSFER_LIST, requestList);
        return true;
    }
}
