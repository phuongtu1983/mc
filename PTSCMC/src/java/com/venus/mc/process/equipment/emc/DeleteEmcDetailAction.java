 ...
 * @author kngo
 */
public class DeleteEmcDetailAction extends SpineAction {
    ...
    public boolean doAction(ActionMapping mapping, ActionForm form,
        ...
        String[] arrDetId = request.getParameterValues("emcEquipmentChk");
        try {
            ...
            for (int i = 0; i < length; i++) {
                if (!arrDetId[i].equals("0")) {
                    emcDAO.deleteEmcDetail(NumberUtil.parseInt(arrDetId[i], 0));
                }
            }
