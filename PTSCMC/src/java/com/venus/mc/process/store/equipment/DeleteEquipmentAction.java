...
public class DeleteEquipmentAction extends SpineAction {
    ...
    public boolean doAction(ActionMapping mapping, ActionForm form,
        ...
        String[] arrEquipmentid = request.getParameterValues("equId");
        try {
            ...
            if (arrEquipmentid != null) {
                length = arrEquipmentid.length;
            }
            for (int i = 0; i < length; i++) {
                //       isExist = equipmentDAO.checkDeleted(arrEquipmentid[i]);
                //       if (!isExist) {
                equipmentDAO.deleteEquipment(arrEquipmentid[i]);
                //       } else {
                //           isExist1 = true;
                //       }
            }
