 ...
 */
package com.venus.mc.process.store.mrv.decorator;
 ...
 * @author thcao
 */
public class MrvMaterialDecorator extends TotalTableDecorator {

    public MrvMaterialDecorator() {
        super();
    }
    ...
    public String getReqNumber() {
        MsvMaterialBean bean = (MsvMaterialBean) getCurrentRowObject();
         return bean.getReqNumber() + "<input type=\"hidden\" name=\"reqDetailId\" value=\"" + 
                bean.getReqDetailId() + "\">";
    }
