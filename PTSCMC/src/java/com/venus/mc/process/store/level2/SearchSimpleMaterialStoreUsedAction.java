...
public class SearchSimpleMaterialStoreUsedAction
  extends SpineAction
{
  public boolean doAction(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response)
  {
    ...
    try
    {
      ...
      storeList = storeDAO.searchUsedMaterialStores(fieldid, strFieldvalue, stoId);
    }
    catch (Exception ex)
    {
      LogUtil.error("FAILED:Request:searchUsedMaterialStores-" + ex.getMessage());
      ex.printStackTrace();
    }
