...
public class DeleteRepairNotPlanAction extends SpineAction {
    ...
    public boolean doAction(ActionMapping mapping, ActionForm form,
        ...
        String[] arrRepairNotPlanid = request.getParameterValues("rnpId");
        try {
            ...
            if (arrRepairNotPlanid != null) {
                length = arrRepairNotPlanid.length;
            }
            for (int i = 0; i < length; i++) {
                //       isExist = repairnotplanDAO.checkDeleted(arrRepairNotPlanid[i]);
                //       if (!isExist) {
                repairnotplanDAO.deleteRepairNotPlan(arrRepairNotPlanid[i]);
                //       } else {
                //           isExist1 = true;
                //       }
            }
