...
public class DeleteRepairPlanAction extends SpineAction {
    ...
    public boolean doAction(ActionMapping mapping, ActionForm form,
        ...
        try {
            ...
            for (int i = 0; i < length; i++) {
                //       isExist = repairplanDAO.checkDeleted(arrRepairPlanid[i]);
                //       if (!isExist) {
                repairplanDAO.deleteRepairPlan(arrRepairPlanid[i]);
                //       } else {
                //           isExist1 = true;
                //       }
            }
