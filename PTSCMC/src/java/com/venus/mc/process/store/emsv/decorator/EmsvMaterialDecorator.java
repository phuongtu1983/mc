 ...
 */
package com.venus.mc.process.store.emsv.decorator;

import com.venus.mc.process.store.msv.decorator.*;
 ...
 * @author thcao
 */
public class EmsvMaterialDecorator extends TotalTableDecorator {

    public EmsvMaterialDecorator() {
        super();
    }

    public String getDelId() {
        EmsvMaterialBean bean = (EmsvMaterialBean) getCurrentRowObject();        
    ...
    public String addRowId() {
        EmsvMaterialBean bean = (EmsvMaterialBean) getCurrentRowObject();
        return "emsv_row_" + bean.getDetId();
    }
}
