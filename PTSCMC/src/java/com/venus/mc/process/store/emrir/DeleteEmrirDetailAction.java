 ...
 * @author kngo
 */
public class DeleteEmrirDetailAction extends SpineAction {
    ...
    public boolean doAction(ActionMapping mapping, ActionForm form,
        ...
        String[] arrDetId = request.getParameterValues("emrirMaterialChk");
        try {
            ...
            for (int i = 0; i < length; i++) {
                if (!arrDetId[i].equals("0")) {
                    mrirDAO.deleteEmrirDetail(NumberUtil.parseInt(arrDetId[i], 0));
                }
            }
