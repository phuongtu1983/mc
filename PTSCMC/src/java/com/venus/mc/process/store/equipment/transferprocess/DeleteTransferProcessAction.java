...
public class DeleteTransferProcessAction extends SpineAction {
    ...
    public boolean doAction(ActionMapping mapping, ActionForm form,
        ...
        String[] arrTransferProcessid = request.getParameterValues("tpId");
        try {
            ...
            if (arrTransferProcessid != null) {
                length = arrTransferProcessid.length;
            }
            for (int i = 0; i < length; i++) {
                //       isExist = transferprocessDAO.checkDeleted(arrTransferProcessid[i]);
                //       if (!isExist) {
                transferprocessDAO.deleteTransferProcess(arrTransferProcessid[i]);
                //       } else {
                //           isExist1 = true;
                //       }
            }
