...
public class RepairPlanFormAction extends SpineAction {
    ...
    public boolean doAction(ActionMapping mapping, ActionForm form,
        ...
        int rpId = NumberUtil.parseInt(request.getParameter("rpId"), 0);
        ...
        if (rpId > 0) {
            ...
            try {
                bean = rpDAO.getRepairPlan(rpId, equId, assId);
                arrRepairMaterial = rpDAO.getRepairMaterials(rpId);
            } catch (Exception ex) {
            }
            request.setAttribute(Constants.REPAIR_MATERIAL_LIST, arrRepairMaterial);
        }
