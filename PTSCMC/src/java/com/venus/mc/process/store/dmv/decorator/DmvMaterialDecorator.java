 ...
 */
package com.venus.mc.process.store.dmv.decorator;
 ...
 * @author thcao
 */
public class DmvMaterialDecorator extends TotalTableDecorator {

    public DmvMaterialDecorator() {
        super();
    }
