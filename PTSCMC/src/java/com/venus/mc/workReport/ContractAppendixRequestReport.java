...
public class ContractAppendixRequestReport
  extends SpineReportParser
{
  ...
  public ContractAppendixRequestReport(String xmlTemplate, String wordTemplate, String resultFileName)
  {
    ...
    throws Exception
  {
    ...
    for (int i = 0; i < reqDetails.size(); i++)
    {
      ...
      if (reqIds.indexOf("," + request.getReqId() + ",") == -1)
      {
        reqIds = reqIds + request.getReqId() + ",";
