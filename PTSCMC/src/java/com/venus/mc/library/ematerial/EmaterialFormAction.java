...
public class EmaterialFormAction extends SpineAction {
    ...
    public boolean doAction(ActionMapping mapping, ActionForm form,
        ...
        String ematId = request.getParameter("ematId");
        bean.setCode("");
        if (!GenericValidator.isBlankOrNull(ematId)) {
            EmaterialDAO materialDAO = new EmaterialDAO();
            try {
                bean = materialDAO.getEmaterial(ematId);
            } catch (Exception ex) {
            }
        }
