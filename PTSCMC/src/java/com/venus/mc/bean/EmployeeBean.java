...
public class EmployeeBean {
    ...
    public EmployeeBean(int empId) {
        this.empId = empId;
    }

    public EmployeeBean(int empId, String code, String fullname, String nickname, String password, String email, String officePhone, String handPhone, String homePhone, int status, String createdDate, String modifiedDate, String lastLogonDate, String firstIp, String lastIp) {
        this.empId = empId;
        this.code = code;
