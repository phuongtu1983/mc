 ...
 * @author mai vinh loc
 */
public class DeleteTechEvalGroupAction extends SpineAction {
    ...
    public boolean doAction(ActionMapping mapping, ActionForm form,
        ...
        String[] arrEvalGroupId = request.getParameterValues("techEvalEmployeeChk");
        try {
            ...
            for (int i = 0; i < length; i++) {
                techDAO.deleteTechEvalGroup(arrEvalGroupId[i]);
            }
        } catch (Exception ex) {
