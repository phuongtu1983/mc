 ...
 * @version
 */
public class SearchSimpleVendorEvalAction extends SpineAction {
    ...
    public boolean doAction(ActionMapping mapping, ActionForm form,
        ...
        try {
            vendorEvalList = vendorDAO.searchSimpleVendorEval(venId, fieldid, StringUtil.encodeHTML(strFieldvalue));
        } catch (Exception ex) {
            LogUtil.error("FAILED:VenderEval:searchSimple-" + ex.getMessage());
            ex.printStackTrace();
        }
