 ...
 * @version
 */
public class SearchSimpleVendorContactAction extends SpineAction {
    ...
    public boolean doAction(ActionMapping mapping, ActionForm form,
        ...
        try {
            vendorList = vendorDAO.searchSimpleVendorContact(venId, fieldid, StringUtil.encodeHTML(strFieldvalue));
        } catch (Exception ex) {
            LogUtil.error("FAILED:VenderContact:searchSimple-" + ex.getMessage());
            ex.printStackTrace();
        }
        request.setAttribute(Constants.VENDOR_CONTACT_LIST, vendorList);
        return true;
    }
}
