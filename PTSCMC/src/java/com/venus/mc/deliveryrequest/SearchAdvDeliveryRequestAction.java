 ...
 * @version
 */
public class SearchAdvDeliveryRequestAction extends SpineAction {
    ...
    public boolean doAction(ActionMapping mapping, ActionForm form,
        ...
        try {
            contractList = contractDAO.searchAdvDeliveryRequest(formBean);
        } catch (Exception ex) {
            LogUtil.error("FAILED:Contract:searchAdv-" + ex.getMessage());
            ex.printStackTrace();
        }
        request.setAttribute(Constants.DELIVERYREQUEST_LIST, contractList);
        return true;
    }
}
