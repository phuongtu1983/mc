...
<form action="addMaterial.do" name="addMaterial">
    <table border="0" width="100%" cellspacing="0" cellpadding="0" >
        <tr><td><div align="center">
                    <table width="100%" border="0" cellspacing="0" cellpadding="0" style="border-width: 0px">
                        ...
                        <logic:greaterThan name="<%=Constants.MATERIAL%>" value="0" property="matId">
                            <tr><td colspan="6">&nbsp;</td></tr>
                            <tr>
                                <td colspan="6"><div id='divMaterialAttachFileSystem' ><img src="img/indicator.gif"/></div></td>            
                            </tr>
                        </logic:greaterThan>
                    </table>
                    <p style="margin-top: 0; margin-bottom: 0" align="left">
                        <%
                                    if (PermissionUtil.hasPermission(request, PermissionUtil.FUNC_EDIT, PermissionUtil.PER_LIBRARY_MATERIAL_COMPANY)) {
                        %>
                        <html:image onclick="return saveMaterial();" src="images/but_save.gif" style="cursor: hand;"/><img border="0" src="images/blank.gif" width="2" height="17">
                        <%}%>
                        <html:image property="Back" value="Back" src="images/but_back.gif" onclick="return loadMaterialList();"/>
                </div></td></tr></table>
