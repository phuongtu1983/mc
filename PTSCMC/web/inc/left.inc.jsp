    ...
    <tr>
        <td id="navMenuContainer" background="images/im101.gif">
            ...
            <div style="width:217px;margin-left:1px;margin-top:0;" dojoType="dijit.Menu" id="navMenu">
                ...
                <div dojoType="dijit.PopupMenuItem" id="navMenuPopupItem2">
                    ...
                    <div dojoType="dijit.Menu" id="navMenuSub2">
                        ...
                        <div dojoType="dijit.MenuItem" id="navMenuSub2_item7"
                             onClick="loadGroupMaterialList();"><bean:message key="message.menu214.text"/></div>     
                        <%}%>
                ...
                <%}%>
                <%if (PermissionUtil.hasPermission(request, PermissionUtil.FUNC_LIST, PermissionUtil.PER_LIBRARY_CERTIFICATE)) {%>
                <div dojoType="dijit.MenuItem"
                     onClick="loadCertificateList();"><bean:message key="message.menu76.text"/></div>
                <%}%>
                <%if (PermissionUtil.hasPermission(request, PermissionUtil.FUNC_LIST, PermissionUtil.PER_LIBRARY_INCOTERM)) {%>
                <div dojoType="dijit.MenuItem"
                     onClick="loadIncotermList();"><bean:message key="message.menu77.text"/></div>
                <%}%>
            ...
            <div style="width:217px;margin-left:1px;margin-top:0;" dojoType="dijit.Menu" id="navMenu1">
                ...
                <div dojoType="dijit.PopupMenuItem" id="navMenuPopupItem3">
                    ...
                    <div dojoType="dijit.Menu" id="navMenuSub3">
                        ...
                        <%}%>
                        <%if (PermissionUtil.hasPermission(request, PermissionUtil.FUNC_LIST, PermissionUtil.PER_PURCHASING_REQUEST_MATERIALNOTCODE)) {%>
                        <div dojoType="dijit.MenuItem" id="navMenuSub3_item10" iconClass="mcMenuIconList"
                             onClick="loadMaterialListNotCode();"><bean:message key="message.menu2110.text"/></div>
                        <%}%>
                        <%if (PermissionUtil.hasPermission(request, PermissionUtil.FUNC_LIST, PermissionUtil.PER_PURCHASING_REQUEST_MATERIAL)) {%>
                ...
                <%}%>
                <%if (PermissionUtil.hasPermission(request, PermissionUtil.FUNC_LIST, PermissionUtil.PER_PURCHASING_INTERMEMO)) {%>
                ...
                <%}%>
                <%if (PermissionUtil.hasPermission(request, PermissionUtil.FUNC_LIST, PermissionUtil.PER_PURCHASING_TENDERPLAN)) {%>
                ...
                <%}%>
                <%if (PermissionUtil.hasOneOfPermission(request, PermissionUtil.FUNC_LIST, PermissionUtil.PER_PURCHASING_CONTRACT + "," + PermissionUtil.PER_PURCHASING_CONTRACT + "," + PermissionUtil.PER_PURCHASING_PRINCIPLE + "," + PermissionUtil.PER_PURCHASING_CONTRACT_FOLLOW + "," + PermissionUtil.PER_PURCHASING_CONTRACT_EXECUTE + "," + PermissionUtil.PER_PURCHASING_ORDER + "," + PermissionUtil.PER_PURCHASING_DELIVERYREQUEST)) {%>
                <div dojoType="dijit.PopupMenuItem" id="navMenuPopupItem6">
                    ...
                    <div dojoType="dijit.Menu" id="navMenuSub6">
                        ...
                        <div dojoType="dijit.MenuItem" id="navMenuSub6_item1" iconClass="mcMenuIconList"
                             onClick="loadContractList('kind=<%=ContractBean.KIND_CONTRACT%>');"><bean:message key="message.menu343.text"/></div>
                        <%}%>
                        <%if (PermissionUtil.hasPermission(request, PermissionUtil.FUNC_LIST, PermissionUtil.PER_PURCHASING_PRINCIPLE)) {%>
                        ...
                        <%}%>
                        <%if (PermissionUtil.hasPermission(request, PermissionUtil.FUNC_LIST, PermissionUtil.PER_PURCHASING_CONTRACT_FOLLOW)) {%>
                        ...
                        <div dojoType="dijit.MenuItem" id="navMenuSub6_item4"
                             onClick="printReportContractForm(<%=ContractBean.KIND_CONTRACT%>,'<bean:message key="message.menu342.text"/>');"><bean:message key="message.menu342.text"/></div>
                        <%}%>
                        <%if (PermissionUtil.hasPermission(request, PermissionUtil.FUNC_LIST, PermissionUtil.PER_PURCHASING_ORDER)) {%>
                        <div dojoType="dijit.MenuItem"
                             onClick="loadOrderList();"><bean:message key="message.menu35.text"/></div>
                        <%}%>
                        <%if (PermissionUtil.hasPermission(request, PermissionUtil.FUNC_LIST, PermissionUtil.PER_PURCHASING_DELIVERYREQUEST)) {%>
                        <div dojoType="dijit.MenuItem"
                ...
                <%}%>
                <%if (PermissionUtil.hasPermission(request, PermissionUtil.FUNC_LIST, PermissionUtil.PER_PURCHASING_DELIVERYNOTICE)) {%>
                <div dojoType="dijit.MenuItem" 
                     onClick="loadDnList();"><bean:message key="message.menu38.text"/></div>
                <%}%>                
                <%if (PermissionUtil.hasPermission(request, PermissionUtil.FUNC_LIST, PermissionUtil.PER_PURCHASING_INVOICE)) {%>
                <div dojoType="dijit.MenuItem"
                     onClick="loadInvoiceList();"><bean:message key="message.menu371.text"/></div>
                <%}%>
                <%if (PermissionUtil.hasPermission(request, PermissionUtil.FUNC_LIST, PermissionUtil.PER_PURCHASING_PAYMENT)) {%>
                <div dojoType="dijit.MenuItem"
            ...
            <div style="width:217px;margin-left:1px;margin-top:0;" dojoType="dijit.Menu" id="navMenu2">
                ...
                <div dojoType="dijit.PopupMenuItem" id="navMenuPopupItem21">
                    ...
                    <div dojoType="dijit.Menu" id="navMenuSub211">
                        ...
                        <div dojoType="dijit.MenuItem" id="navMenuSub211_item2" iconClass="mcMenuIconNew"
                             onClick="mrirForm();"><bean:message key="message.menu413.text"/></div>
                        <%}%>
                        ...
                        <%}%>
                        <%if (PermissionUtil.hasPermission(request, PermissionUtil.FUNC_LIST, PermissionUtil.PER_STOCK_MRIR)) {%>
                        <div dojoType="dijit.MenuItem" id="navMenuSub211_item5" iconClass="mcMenuIconList"
                             onClick="loadMCProjectStoreMrirReportForm();"><bean:message key="message.menu414.text"/></div>
                        <%}%>
                    </div>
                </div>
                <%}%>
                ...
                <%}%>
                <%if (PermissionUtil.hasPermission(request, PermissionUtil.FUNC_LIST, PermissionUtil.PER_STOCK_RFM_MATERIAL)) {%>
                <div dojoType="dijit.PopupMenuItem" id="navMenuPopupItem43">
                    ...
                    <div dojoType="dijit.Menu" id="navMenuSub43">
                        ...
                        <%}%>
                        <%if (PermissionUtil.hasPermission(request, PermissionUtil.FUNC_LIST, PermissionUtil.PER_STOCK_RFM)) {%>
                ...
                <%}%>
                <%if (PermissionUtil.hasPermission(request, PermissionUtil.FUNC_LIST, PermissionUtil.PER_STOCK_MIV)) {%>
                <div dojoType="dijit.MenuItem"
                     onClick="loadMivList(<%=MivBean.KIND_COMPANY%>);"><bean:message key="message.menu44.text"/></div>
                <%}%>
                <%if (PermissionUtil.hasOneOfPermission(request, PermissionUtil.FUNC_LIST, PermissionUtil.PER_STOCK_REPORT_REQUEST + "," + PermissionUtil.PER_STOCK_REPORT_STORE + "," + PermissionUtil.PER_STOCK_REPORT_STORE_PROJECT + "," + PermissionUtil.PER_STOCK_REPORT_BALANCE+","+PermissionUtil.PER_STOCK_REPORT_STORE_LEVEL2)) {%>
                <div dojoType="dijit.PopupMenuItem" id="navMenuPopupItem441">
                    ...
                    <div dojoType="dijit.Menu" id="navMenuSub441">
                        <%if (PermissionUtil.hasPermission(request, PermissionUtil.FUNC_LIST, PermissionUtil.PER_STOCK_REPORT_REQUEST)) {%>
                        ...
                        <%}%>
                        <%if (PermissionUtil.hasPermission(request, PermissionUtil.FUNC_LIST, PermissionUtil.PER_STOCK_REPORT_STORE)) {%>
                        <div dojoType="dijit.MenuItem" id="navMenuSub441_item2"
                             onClick="loadMCReportForm();"><bean:message key="message.menu4412.text"/></div>
                        <%}%>
                        <%if (PermissionUtil.hasPermission(request, PermissionUtil.FUNC_LIST, PermissionUtil.PER_STOCK_REPORT_STORE_PROJECT)) {%>
                        ...
                        <%}%>
                        <%if (PermissionUtil.hasPermission(request, PermissionUtil.FUNC_LIST, PermissionUtil.PER_STOCK_REPORT_BALANCE)) {%>
                        ...
                        <%}%>
                        <%if (PermissionUtil.hasPermission(request, PermissionUtil.FUNC_LIST, PermissionUtil.PER_STOCK_REPORT_STORE_LEVEL2)) {%>
                        <div dojoType="dijit.MenuItem" id="navMenuSub441_item5"
                             onClick="loadStoreLevel2BalanceReportForm();"><bean:message key="message.menu4416.text"/></div>
                        <%}%>
                    </div>
                </div>
                <%}%>
                <%if (PermissionUtil.hasPermission(request, PermissionUtil.FUNC_LIST, PermissionUtil.PER_STOCK_INVENTORY)) {%>
                ...
                <%}%>
                <%if (PermissionUtil.hasOneOfPermission(request, PermissionUtil.FUNC_LIST, PermissionUtil.PER_PURCHASING_DELIVERYNOTICE_PROJECT + "," + PermissionUtil.PER_STOCK_PROJECT_MRIR + "," + PermissionUtil.PER_STOCK_PROJECT_MSV + "," + PermissionUtil.PER_STOCK_PROJECT_STATISTICS + "," + PermissionUtil.PER_STOCK_PROJECT_RFM + "," + PermissionUtil.PER_STOCK_PROJECT_MSV)) {%>
                <div dojoType="dijit.PopupMenuItem" id="navMenuPopupItem45">
                    <span><bean:message key="message.menu432.e_text"/></span>
                    <div dojoType="dijit.Menu" id="navMenuSub45">
                        <%if (PermissionUtil.hasPermission(request, PermissionUtil.FUNC_LIST, PermissionUtil.PER_PURCHASING_DELIVERYNOTICE_PROJECT)) {%>
                        <div dojoType="dijit.MenuItem" id="navMenuSub1_item450" iconClass="mcMenuIconList"
                             onClick="loadEdnList();"><bean:message key="message.menu381.text"/></div>
                        <%}%>
                        <%if (PermissionUtil.hasPermission(request, PermissionUtil.FUNC_LIST, PermissionUtil.PER_STOCK_PROJECT_MRIR)) {%>
                        <div dojoType="dijit.MenuItem" id="navMenuSub1_item451"
                             onClick="loadEmrirList();"><bean:message key="message.menu41.text"/></div>
                        <%}%>
                        <%if (PermissionUtil.hasPermission(request, PermissionUtil.FUNC_LIST, PermissionUtil.PER_STOCK_PROJECT_MSV)) {%>
                        <div dojoType="dijit.MenuItem" id="navMenuSub1_item452"
                             onClick="loadEmsvTab();"><bean:message key="message.menu42.text"/></div>
                        <%}%>
                        <%if (PermissionUtil.hasPermission(request, PermissionUtil.FUNC_LIST, PermissionUtil.PER_STOCK_PROJECT_STATISTICS)) {%>
                        ...
                        <%}%>
                        <%if (PermissionUtil.hasPermission(request, PermissionUtil.FUNC_LIST, PermissionUtil.PER_STOCK_PROJECT_RFM)) {%>
                ...
                <div style="width:217px;margin-left:1px;margin-top:0;" dojoType="dijit.Menu" id="navMenu2">
                    ...
                    <div dojoType="dijit.PopupMenuItem" id="navMenuPopupItem480">
                        ...
                        <div dojoType="dijit.Menu" id="navMenuSub480">
                            <%if (PermissionUtil.hasPermission(request, PermissionUtil.FUNC_LIST, PermissionUtil.PER_STOCK_YCKT_STORE2)) {%>
                            ...
                            <%}%>
                            <%if (PermissionUtil.hasPermission(request, PermissionUtil.FUNC_LIST, PermissionUtil.PER_STOCK_YCKT_REDUNDANT)) {%>
                            ...
                            <%}%>
                            <%if (PermissionUtil.hasPermission(request, PermissionUtil.FUNC_LIST, PermissionUtil.PER_STOCK_YCKT_PROJECT)) {%>
                ...
                <%if (PermissionUtil.hasPermission(request, PermissionUtil.FUNC_LIST, PermissionUtil.PER_EQUIPMENT_COLOR)) {%>
                <div dojoType="dijit.MenuItem"
                ...
                <%if (PermissionUtil.hasPermission(request, PermissionUtil.FUNC_LIST, PermissionUtil.PER_EQUIPMENT)) {%>
                <div dojoType="dijit.MenuItem"
                 onClick="loadDnTestList();"><bean:message key="message.menu50a.text"/></div>
                <div dojoType="dijit.MenuItem"
                ...
                <%if (PermissionUtil.hasPermission(request, PermissionUtil.FUNC_LIST, PermissionUtil.PER_EQUIPMENT_FACTREPORT)) {%>
                <div dojoType="dijit.MenuItem"
                     onClick="loadReportDamageList();"><bean:message key="message.menu60.text"/></div>
                <%}%>
                <%if (PermissionUtil.hasPermission(request, PermissionUtil.FUNC_LIST, PermissionUtil.PER_EQUIPMENT_REPAIRREQUEST)) {%>
                <div dojoType="dijit.MenuItem"
                ...
                <%}%>
                <%if (PermissionUtil.hasPermission(request, PermissionUtil.FUNC_LIST, PermissionUtil.PER_EQUIPMENT_SURVEYREPORT)) {%>
                <div dojoType="dijit.MenuItem"
                ...
                <%if (PermissionUtil.hasPermission(request, PermissionUtil.FUNC_LIST, PermissionUtil.PER_EQUIPMENT_MC)) {%>
                ...
                <%}%>
                <%if (PermissionUtil.hasPermission(request, PermissionUtil.FUNC_LIST, PermissionUtil.PER_EQUIPMENT_MCO)) {%>
                ...
                <%}%>
                <%if (PermissionUtil.hasPermission(request, PermissionUtil.FUNC_LIST, PermissionUtil.PER_EQUIPMENT_EMC)) {%>
                ...
                <%}%>
                <%if (PermissionUtil.hasPermission(request, PermissionUtil.FUNC_LIST, PermissionUtil.PER_EQUIPMENT_EMCO)) {%>
