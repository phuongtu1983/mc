...
<form action="addAssetRepairPlan.do" name="addAssetRepairPlan">
    <table border="0" width="100%" cellspacing="0" cellpadding="0" >
        <tr><td><div align="center">
                        ...
                        <tr>
                            <td colspan="4">
                                <fieldset>
                                    ...
                                    <p><div id="listRepairMaterialDataDiv" style="width:700px;height:300px;overflow:auto"><%@include  file="/process/store/asset/repairplan/details.jsp" %></div></p>
                                </fieldset>
                            </td>
                        </tr>
                        <tr>
                                ...
                                <fieldset>
                                    ...
                                    <table width="100%" border="0">
                                        <tr>
                                            ...
                                            <html:select onchange="document.forms['addAssetRepairPlan'].performKind.item(0).checked=true;" property="orgId" name="<%=Constants.REPAIRPLAN%>" >
                                        ...
                                        <tr>
                                            ...
                                            <td height="22" colspan="3"><html:text property="performPart" onchange="document.forms['addAssetRepairPlan'].performKind.item(1).checked=true;" size="100" name="<%=Constants.REPAIRPLAN%>"/></td>
                                        </tr>
                                    </table>
                                    </p>
                                </fieldset>
                    ...
                    <p style="margin-top: 0; margin-bottom: 0" align="left">
                        ...
                        <html:image onclick="return saveAssetRepairPlan();" src="images/but_save.gif" style="cursor: hand;"/><img border="0" src="images/blank.gif" width="2" height="17">
                        <%}%>
                        <html:image property="Back" value="Back" src="images/but_back.gif" onclick="return loadAssetRepairPlan();"/>
                </div></td></tr></table>
