    ...
    <tbody>
        <logic:present name="<%=Constants.REPAIR_MATERIAL_LIST%>">
            <logic:iterate id="detail" name="<%=Constants.REPAIR_MATERIAL_LIST%>">
                <tr>
                    <td width="30px">
                        <div align="center"><input type="checkbox" name="rmId" value="<bean:write name="detail" property="rmId"/>"/></div>
                        <input type="hidden" name="delDetId" value="<bean:write name="detail" property="rmId"/>"/>
