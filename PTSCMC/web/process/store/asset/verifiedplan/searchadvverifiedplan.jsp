...
<form id='searchAssetVerifiedPlanForm' name='searchAssetVerifiedPlanForm'>
    <table border="0" width="100%" cellspacing="0" cellpadding="0" >
        <tr><td><div align="center">
                ...
                <html:image property="Submit" value="Submit" src="images/but_find.gif" style="cursor: hand;" onclick="return searchAdvAssetVerifiedPlan();"/>
