...
<html:form styleId="searchRepairPlan" action="searchRepairPlan.do">
    <table>            
        <tr>
            <td>
                <html:image src="images/blank.png" onclick="return searchRepairPlan();"/>
                <%if (PermissionUtil.hasPermission(request, PermissionUtil.FUNC_DELETE, PermissionUtil.PER_EQUIPMENT)) {%>
                <html:image src="images/ico_xoa.gif" onclick="return delRepairPlans();"/>
                <%}%>
                <%if (PermissionUtil.hasPermission(request, PermissionUtil.FUNC_ADD, PermissionUtil.PER_EQUIPMENT)) {%>
                <html:image src="images/ico_them.gif"  onclick="return addRepairPlan();"/>
                <%}%>
            </td>
            <td><div>
                    ...
                    <html:submit onclick="return searchRepairPlan();"><bean:message key="message.search"/></html:submit>
                    <html:submit onclick="return searchAdvRepairPlanForm();"><bean:message key="message.detailSearch"/></html:submit>
            </div></td>
        </tr>
    </table>
</html:form>
