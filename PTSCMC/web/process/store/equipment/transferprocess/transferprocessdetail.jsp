...
<form action="addTransferProcess.do" name="addTransferProcess">
        ...
        <tr><td><div align="center">
                    <table width="100%" border="0" cellspacing="0" cellpadding="0" style="border-width: 0px">
                        ...
                        <tr>
                            ...
                            <td height="22">
                                <html:select  property="receiveOrg" onchange="orgChangeTransferProcess(this, this.selectedIndex);" name="<%=Constants.TRANSFERPROCESS%>">
                            ...
                            <td height="22" id="empListCbxTransferProcess"><html:select styleClass="lbl9"  property="receiveEmp" name="<%=Constants.TRANSFERPROCESS%>">
                    ...
                    <p style="margin-top: 0; margin-bottom: 0" align="left">
                        <%
            TransferProcessBean form = (TransferProcessBean) request.getAttribute(Constants.TRANSFERPROCESS);
            if (PermissionUtil.hasPermission(request, PermissionUtil.FUNC_EDIT, PermissionUtil.PER_EQUIPMENT, form.getCreatedEmp())) {
                        %>
                        <html:image onclick="return saveTransferProcess();" src="images/but_save.gif" style="cursor: hand;"/><img border="0" src="images/blank.gif" width="2" height="17">
                        <%}%>
                        <html:image property="Back" value="Back" src="images/but_back.gif" onclick="return loadTransferProcess();"/>
                </div></td></tr></table>
