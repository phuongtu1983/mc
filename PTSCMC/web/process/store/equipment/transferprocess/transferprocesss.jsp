...
<display:table style="width:100%" pagesize="15" requestURI="javascript:loadTransferProcessListSort({})" name="<%=Constants.TRANSFERPROCESS_LIST%>" id="transferprocess" class="its" >
    ...
    <display:column titleKey="message.transferprocess.receiveOrg" sortable="true" headerClass="sortable">
        <a href="#" name="tpId" onclick="addTransferProcess(<%=((TransferProcessBean)pageContext.getAttribute("transferprocess")).getTpId()%>)"><%=((TransferProcessBean)pageContext.getAttribute("transferprocess")).getOrgName()%></a>
    </display:column>
    <display:column titleKey="message.transferprocess.receiveDate" sortable="true" headerClass="sortable">
        <a href="#" name="tpId" onclick="addTransferProcess(<%=((TransferProcessBean)pageContext.getAttribute("transferprocess")).getTpId()%>)"><%=((TransferProcessBean)pageContext.getAttribute("transferprocess")).getReceiveDate()%></a>
    </display:column> 
    <display:column titleKey="message.transferprocess.returnDate" sortable="true" headerClass="sortable">
        <a href="#" name="tpId" onclick="addTransferProcess(<%=((TransferProcessBean)pageContext.getAttribute("transferprocess")).getTpId()%>)"><%=((TransferProcessBean)pageContext.getAttribute("transferprocess")).getReturnDate()%></a>
    </display:column>     
    <display:column titleKey="message.transferprocess.comment" sortable="true" headerClass="sortable">
        <a href="#" name="tpId" onclick="addTransferProcess(<%=((TransferProcessBean)pageContext.getAttribute("transferprocess")).getTpId()%>)"><%=((TransferProcessBean)pageContext.getAttribute("transferprocess")).getComment()%></a>
    </display:column> 
    <%}else{%>
