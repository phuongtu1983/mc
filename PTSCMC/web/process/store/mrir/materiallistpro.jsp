...
<display:table style="width:1600px;" name="<%=Constants.MATERIAL_LIST%>" id="mrirMaterial" class="its" decorator="com.venus.mc.process.store.mrir.decorator.MrirMaterialDecorator">
    ...
    <display:column style="width:100px;" property="reqNumber" titleKey="message.mrir.reqId"/>
