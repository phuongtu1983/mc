...
<%
            ...
            int mrirId = (int) NumberUtil.parseInt(request.getAttribute("mrirId").toString(), 0);
%>
<h3><bean:message key="message.detailmaterial.title"/></h3>
<div id="errorMaterialMessageDiv"></div>
<form name="addMaterialOsD">
                    ...
                    <table width="100%" border="0" cellspacing="0" cellpadding="0" style="border-width: 0px">
                        ...
                        <tr>
                            ...
                            <td height="22" colspan="5">
                                <html:select  property="uniId" onchange="document.forms['addMaterialOsD'].uniIdEn.options.selectedIndex=this.options.selectedIndex" name="<%=Constants.MATERIAL%>">
                        ...
                        <tr>
                            ...
                            <td height="22" colspan="5">
                                <html:select  property="uniIdEn" onchange="document.forms['addMaterialOsD'].uniId.options.selectedIndex=this.options.selectedIndex" name="<%=Constants.MATERIAL%>">
                                <html:options collection="<%=Constants.UNIT_LISTEN%>" property="value" labelProperty="label"/> </html:select>
                            </td>
                        </tr>
                    </table>
                    <p style="margin-top: 0; margin-bottom: 0" align="left">
                    <html:image onclick="return saveMaterialOsD(document.forms['addMaterialOsD'].detId.value,document.forms['addMaterialOsD'].osdId.value);" src="images/but_save.gif" style="cursor: hand;"/><img border="0" src="images/blank.gif" width="2" height="17">
    </div></td></tr></table>
    <input type="hidden" name="detId" value ="<%=detId%>"/>
    <input type="hidden" name="osdId" value ="<%=osdId%>"/>
    <input type="hidden" name="mrirId" value ="<%=mrirId%>"/>
</form>
