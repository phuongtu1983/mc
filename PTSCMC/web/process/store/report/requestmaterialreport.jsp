...
<h3><bean:message key="message.menu441.u_text"/>/<bean:message key="message.menu4411.text.s"/></h3>
<form name="mcReportForm">
    <table>
        ...
        <tr>
            <td><img onclick="return printMCRequestReport();" src="images/but_print.gif"/></td>
        </tr>
    </table>
</form>