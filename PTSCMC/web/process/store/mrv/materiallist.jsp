...
<display:table style="width:100%" name="<%=Constants.MATERIAL_LIST%>" id="mrvMaterial" class="its" decorator="com.venus.mc.process.store.mrv.decorator.MrvMaterialDecorator">
