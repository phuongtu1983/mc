...
<table id="bidEvalSumDetailDetailTable">
    <logic:iterate id="detail" name="<%=Constants.MATERIAL_LIST%>">
        <tr>
            ...
            <td width="40px"><html:text styleClass="lbl10" style="border-width:1px;text-align:right" size="10" name="detail" property="vat" styleId="detvat${detail.matId}_${detail.reqDetailId}"  onblur="caculateContractDetail('${detail.matId}_${detail.reqDetailId}')"/></td>
            <%} else {%>
