...
<table id="bidEvalSumGroupTbl" class="its"  style="width:100%">
    <thead>
        <tr>
    ...
    <tbody>
        <logic:iterate id="employee" name="<%=Constants.EMPLOYEE_LIST%>">
            <tr>
                <td>
                    <input type="checkbox" name="bidEvalSumEmployeeChk" value="<bean:write name="employee" property="besgId"/>"/>
                    <input type="hidden" name="evalId" value="<bean:write name="employee" property="besgId"/>"/>
                </td>
