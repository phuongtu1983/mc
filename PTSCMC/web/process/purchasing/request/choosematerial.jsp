    ...
    <table width="100%">
        <tr><td>
                <fieldset>
                    ...
                    <div id='materialRequestSelectedDiv'>
                        <input type="button" onclick="return delMaterialRequest();" value="<bean:message key="message.del"/>"/>&nbsp;<input type="button" onclick="return chooseMaterialSelected();" value="<bean:message key="message.ok"/>"/>
                        <form name="materialRequestSelectedForm">
        ...
        <tr><td>           
                <form name="selectMaterialForm">
                    ...
                    <input type="button" onclick="return searchMaterialRequest();" value="<bean:message key="message.search"/>"/>&nbsp;<input type="button" onclick="return setMaterialSelected();" value="<bean:message key="message.choose"/>"/>
                </form>                
        </td></tr>
    </table>
