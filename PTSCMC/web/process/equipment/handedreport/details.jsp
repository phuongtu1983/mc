...
<display:table htmlId="handedReportDetailTable" style="width:100%" name="<%=Constants.HANDEDREPORT_DETAIL_LIST%>" id="detail" class="its" decorator="com.venus.mc.process.equipment.handedreport.decorator.HandedReportEquimentDecorator">
