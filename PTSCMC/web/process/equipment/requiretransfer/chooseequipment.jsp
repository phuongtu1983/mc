    ...
    <table width="100%">
        <tr><td>
                <fieldset>
                    ...
                    <div id='materialRequestSelectedDiv'>
                        <input type="button" onclick="return delEquipmentRequest();" value="<bean:message key="message.del"/>"/>&nbsp;<input type="button" onclick="return chooseEquipmentRequireTransferSelected();" value="<bean:message key="message.ok"/>"/>
        ...
        <tr><td>           
                <form name="selectMaterialForm">
                    ...
                    <input type="button" onclick="return searchEquipmentRequireTransfer();" value="<bean:message key="message.search"/>"/>&nbsp;<input type="button" onclick="return setEquipmentSelected();" value="<bean:message key="message.choose"/>"/>
                </form>                
        </td></tr>
    </table>
