...
<display:table htmlId="requireTransferMaterialTable" style="width:100%" name="<%=Constants.EQUIPMENT_LIST%>" id="detail" class="its" decorator="com.venus.mc.process.equipment.requiretransfer.decorator.RequireTransferEquimentDecoratorEx">
