    ...
    <table width="100%">
        ...
        <tr><td>           
                <form name="selectMaterialForm">
                    ...
                    <input type="button" onclick="return searchEquipmentHr();" value="<bean:message key="message.search"/>"/>&nbsp;<input type="button" onclick="return setEquipmentSelected();" value="<bean:message key="message.choose"/>"/>
                </form>                
        </td></tr>
    </table>
