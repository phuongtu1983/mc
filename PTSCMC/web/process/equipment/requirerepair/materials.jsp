...
<table id="equipmentTable" style="width:100%">
    <logic:iterate id="material" name="<%=Constants.EQUIPMENT_LIST%>">
        <tr>
            ...
            <td width="80px"><html:text styleClass="lbl10" style="border-width:1px;text-align:right" size="10" name="material" property="quantity"  onblur="return tryNumberFormat(this)" /></td>
