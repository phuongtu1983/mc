    ...
    <table width="100%">
        <tr><td>
                <fieldset>
                    ...
                    <div id='materialRequestSelectedDiv'>
                        <input type="button" onclick="return delMaterialSr();" value="<bean:message key="message.del"/>"/>&nbsp;<input type="button" onclick="return chooseMaterialSrSelected();" value="<bean:message key="message.ok"/>"/>
        ...
        <tr><td>           
                <form name="selectMaterialForm">
                    ...
                    <input type="button" onclick="return searchMaterialSr();" value="<bean:message key="message.search"/>"/>&nbsp;<input type="button" onclick="return setMaterialSrSelected();" value="<bean:message key="message.choose"/>"/>
                </form>                
        </td></tr>
    </table>
