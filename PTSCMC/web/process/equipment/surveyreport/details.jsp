...
<table style="width:100%" width="100%" class="its" id="equipmentDetailTable">
    <thead>
        <tr>
            ...
            <th><bean:message key="message.surveyreport.usedCode"/></th>
            <th><bean:message key="message.surveyreport.equId"/></th>
            <th><bean:message key="message.surveyreport.unit"/></th>
            <th><bean:message key="message.surveyreport.quantity"/></th>
        </tr>
    </thead>
    <tbody>
        <logic:iterate id="detail" name="<%=Constants.SURVEYREPORT_DETAIL_LIST%>">
            <tr>
                <td width="30px">
                ...
                <td width="80px"><html:text styleClass="lbl10" style="border-width:1px;text-align:right" size="10" readonly="true" name="detail" property="quantity"  onblur="return tryNumberFormat(this)" /></td>
            </tr>
        </logic:iterate>
    </tbody>
</table>